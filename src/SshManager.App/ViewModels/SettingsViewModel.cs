...
public partial class SettingsViewModel : ObservableObject
{
    ...
    public event Action? RequestManageSshKeys;
    public event Action? RequestBackupManager;
    public event Action? RequestImportHosts;
    public event Action? RequestExportHosts;
    public event Action? RequestImportSshConfig;
    public event Action? RequestExportSshConfig;
    public event Action? RequestCloudSync;
    ...
    [RelayCommand]
    private void ManageSshKeys()
    {
        RequestManageSshKeys?.Invoke();
    }

    [RelayCommand]
    private void OpenBackupManager()
    {
        RequestBackupManager?.Invoke();
    }

    [RelayCommand]
    private void ImportHosts()
    {
        RequestImportHosts?.Invoke();
    }

    [RelayCommand]
    private void ExportHosts()
    {
        RequestExportHosts?.Invoke();
    }

    [RelayCommand]
    private void ImportSshConfig()
    {
        RequestImportSshConfig?.Invoke();
    }

    [RelayCommand]
    private void ExportSshConfig()
    {
        RequestExportSshConfig?.Invoke();
    }
